...
!      print*, 'nj ', nj
!   
!      print*, 'Shape of xj ', shape(xj) 
!      print*, 'Last element of xj ', xj(nj)
!      print*, 'First element of xj ', xj(1)
! 
!      print*, 'Shape of cj ', shape(cj) 
!      print*, 'Last element of cj ', cj(nj)
!      print*, 'First element of cj ', cj(1)
!
!      print*, 'iflag ', iflag
!
!      print*, 'eps ', eps
